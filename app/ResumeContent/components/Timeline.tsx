...
const events: TimelineEvent[] = [
    ...
    },
    {
        ...
        endDate: '2021',
        title: '某IT企業システム開発',
        description: '金融・証券分野でのシステム開発およびインフラ業界でのプロジェクトリーダーシップとマネジメントを経験。プロジェクトの計画から実行、監視、終了までを一貫して管理し、保守プロジェクトでは納期遵守率100%を達成。上流工程の要点定義やシステム設計など、各フェーズの要求仕様を明確にする役割も担当。2021年には、実績とリーダーシップを認められ主任に昇格する。',
    },
    {
        id: '3',
        startDate: '2021',
    ...
    },
    {
        ...
        endDate: '現在',
        title: '介護に専念するため離職',
        description: '軽微な保守対応、自身のウェブサービスの保守・運営、資格取得に向けた学習を行う。',
    },
];
